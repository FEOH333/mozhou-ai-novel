// server/engine/opening_intervention.js —— V0.98 开篇候选编排、隔离存储与匿名冷读
'use strict';
...
import { applyValidatedScenePatch } from './polish.js';
import { currentStoryYear } from './history.js';
import { appendHistory } from '../llm/cache.js';
import { estimateChineseChars } from '../llm/tokenizer.js';
import { transitionChapterStatus } from './chapter_status.js';
