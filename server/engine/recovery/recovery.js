// server/engine/recovery/recovery.js —— 系统性跑偏检测与自动恢复（V0.16）
...
import { generateVolumeOutline, generateChapterOutline } from '../planning/outline.js';
import { worldExpansionStatus } from '../planning/world_expansion.js'; // V0.83：世界展开停滞并入漂移信号
import { formatRolling } from '../pipeline/archive.js';
