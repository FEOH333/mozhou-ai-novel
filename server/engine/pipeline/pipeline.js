// server/engine/pipeline/pipeline.js —— 章节写作管线编排（细纲→正文→审校→质量债务处理→覆盖→结算）
'use strict';
import * as store from '../../db/store.js';
import { generateChapterOutline } from '../planning/outline.js';
...
import { recordChapterHealth, detectDrift } from '../recovery/recovery.js';
import { checkArchiveNeed } from './archive.js';
import { registerHooksFromOutline, auditPleasure, schedulerCheck, buildPleasureContext, settleHookLedger } from '../quality/pleasure.js';
import { batchQualityScan } from '../quality/batch_scan.js'; // V0.95：三章一轮批次自检
import { getGlobal } from '../../config.js';
import { attractionGate } from '../quality/attraction.js'; // V0.80 逐章吸引力质量门
...
import { syncHistoricalProtagonistState } from '../longform/historical_state.js';
...
import { checkChapterLength } from '../quality/rules.js'; // V0.93.2：短章下限确定性防线
import { fulfillOpeningReaderContract } from '../planning/opening_intervention.js';
import { ensureNarrativeStateReady } from '../narrative/narrative_state.js';
import { stampOpeningTimelineProseFix, isImmediateReplanIssue } from '../longform/historical_guardrails.js';
import { markNarrativeLessonsUsed } from '../quality/narrative_lessons.js';
