// server/engine/pipeline/continuation.js —— V0.44 完本判定与自动续卷引擎
...
import { ensureHistory, publicMaterialsText, generateVolumeOutline } from '../planning/outline.js';
import { extractJSON } from '../../util/json.js';
import { logFlow } from '../../util/oplog.js';
import { endingCheckInstruction, nextVolumeInstruction } from '../prompts.js';
import { detectGrowthDeviation, planRemedyBridge, growthRemedyText } from '../planning/growth.js'; // V0.74 成长线补救
import { detectWorldStagnation, planWorldExpansion, worldProgressText, worldExpansionStatus } from '../planning/world_expansion.js'; // V0.76 世界展开补救
import { eraContextText, historyGrowthNote } from '../narrative/history.js'; // V0.81 历史时代背景 + 成长波动
import {
  buildLifecycleContext, endingBlueprintText, endingReadiness, lifecyclePromptText,
} from '../longform/longform_lifecycle.js'; // V0.92 全书阶段与硬完本门
import { isCompletedChapter } from './chapter_status.js';
import { isHistoricalSampleBook } from '../longform/historical_longform.js'; // V0.93.2：历史特判单一实现
