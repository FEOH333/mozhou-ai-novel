// server/engine/longform/alignment.js —— V0.45 大纲对齐系统（三层检测 + 自动修订）
...
import { ensureHistory, rebuildHistory } from '../planning/outline.js';
...
import { formatBookOutline } from '../planning/outline.js';
...
import { chapterTitleDeliveryIssues } from '../quality/rules.js'; // V0.107：章名↔正文核对闸（写审同源词表）
